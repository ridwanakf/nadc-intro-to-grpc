...
import (
	...
	"github.com/ridwanakf/nadc-intro-to-grpc/constant"
	"github.com/ridwanakf/nadc-intro-to-grpc/internal/app/config"
	"gopkg.in/yaml.v2"
)

type NadcGrpc struct {
	Repos    *Repos
	UseCases *Usecases
	Cfg		 config.Config
}

func NewNadcGrpc() (*NadcGrpc, error) {
